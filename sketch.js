...
function draw() {
  ...
  if(fired){
    ...
    let line_length = v;
    let line_start = {x:projectile_radius, y: canvas_Y - projectile_radius};
...
function projectile(){
  ...
  let x  = vx_0 * t;
  let y =  vy_0 * t + 0.5 * ay * t * t + canvas_Y;
...
//To update velocity and angle labels (to display value of slider beside it)
